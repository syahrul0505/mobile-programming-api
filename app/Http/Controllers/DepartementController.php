...
class DepartementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('master-data.departements.index')->with('success','Departement created successfully');
        } catch (\Throwable $th) {
            return redirect()->back()->with('failed','Departement created Failed');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('master-data.departements.index')->with('success','Departement updated successfully');
    }
