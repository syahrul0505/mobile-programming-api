							...
							<ul class="side-menu">
								...
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item" href="draggablecards.html">Darggablecards</a></li>
									...
									<ul class="slide-menu">
										...
										<li class="sub-slide">
											...
											<ul class="sub-slide-menu">
												...
												<li><a class="sub-side-menu__item" href="switcherpage.html">Switcherpage</a></li>
											</ul>
										</li>
										<li class="sub-slide">
										...
										<li><a class="slide-item" href="emptypage.html">Empty Page</a></li>
									</ul>
								</li>
								<li class="slide">
