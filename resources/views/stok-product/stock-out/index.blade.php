                ...
                <div class="card-header bg-warning" style="border-radius:15px 15px 0px 0px;">
                    <div class="row">
                        ...
                        <div class="col-6 d-flex justify-content-end">
                            <a href="{{ route('stock-out-products.create') }}" class="btn btn-sm btn-info p-2">
                            ...
                            <table id="dataTableStockIn" class="table border text-nowrap customize-table mb-0 align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $stock_out->product_out }}</td>
                                        <td>{{ $stock_out->description }}</td>
                                        @if(auth()->user()->can('stock-out-delete'))
                                        <td>
                                        <div class="dropdown dropstart">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                @can('stock-in-delete')
                                                <a href="#" class="dropdown-item d-flex align-items-center gap-3" onclick="modalDelete('Stock In', '{{ $stock_out->product->name }}', '/stock-out-products/' + {{ $stock_out->id }}, '/stock-out-products/')">
