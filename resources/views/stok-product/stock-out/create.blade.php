...
<div class="container-fluid">
            ...
            <div class="page-title-box d-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('stock-out-products.index') }}">Stock Out</a></li>
    ...
    <div class="col-md-12 mt-4">
        <div class="card" style="border-radius:15px;">
            ...
            <form action="{{ route('stock-out-products.store') }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                <label for="product_out" class="form-label">Stock Out</label>
                                <input type="number" name="product_out" value="{{ old('product_out') }}" class="form-control" placeholder="Ex:10" id="product_out" aria-describedby="product_out">
                            </div>
                            @error('product_out')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
