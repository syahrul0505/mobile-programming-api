    ...
    <div class="row mt-4">
        <div class="col-md-12">
            <div class="card card-primary" style="border-radius:15px;">
                ...
                <form action="{{ route('stock-ins.update',$stock_in->id) }}" method="POST">
                    @method('patch')
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select mr-sm-2 @error('material_id') is-invalid @enderror" id="material_id" name="material_id" style="width:100%">
                                        ...
                                        <option value="{{ $material->id }}"
                                            {{ old('material_id') == $stock_in->masterial_id ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    <label for="material_in" class="form-label">Material In</label>
                                    <input type="number" name="material_in" value="{{ old('material_in') ?? $stock_in->material_in }}" class="form-control" placeholder="material_in" id="material_in" aria-describedby="material_in">
                                </div>
                                @error('material_in')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
