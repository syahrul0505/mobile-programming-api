            ...
            <form action="{{ route('stock-ins.store') }}" method="POST">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                <label for="material_in" class="form-label">Stock In</label>
                                <input type="number" name="material_in" value="{{ old('material_in') }}" class="form-control" placeholder="material_in" id="material_in" aria-describedby="material_in">
                            </div>
                            @error('material_in')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
