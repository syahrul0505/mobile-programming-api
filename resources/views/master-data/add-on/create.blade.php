...
<div class="container-fluid">
    ...
    <div class="col-md-12 mt-4">
        <div class="card" style="border-radius:15px;">
            ...
            <form action="{{ route('master-data.add-ons.store') }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="add_on_name" value="{{ old('add_on_name') }}" class="form-control" placeholder="add_on_name" id="add_on_name" aria-describedby="add_on_name">
                            </div>
                            @error('add_on_name')
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="minimal_choice" value="{{ old('minimal_choice') }}" class="form-control" placeholder="minimal_choice" id="minimal_choice" aria-describedby="minimal_choice">
                            </div>
                    ...
                    <div class="row mt-2">
                        <div class="col-lg-12">
                            <div class="table-responsive">
                                <table class="table table-hover" id="addOnTable">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th>Harga</th>
