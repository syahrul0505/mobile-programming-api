    ...
    <div class="row mt-4">
        <div class="col-12 col-md-6">
            <div class="card" style="border-radius:15px;">
                ...
                <form action="{{ route('master-data.tags.update',$tag->id) }}" method="POST">
                    @method('patch')
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="tag_name" value="{{ old('tag_name') ?? $tag->tag_name }}" class="form-control" placeholder="tag_name" id="tag_name" aria-describedby="tag_name">
                                </div>
                                @error('tag_name')
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="position" value="{{ old('position') ?? $tag->position }}" class="form-control" placeholder="position" id="position" aria-describedby="position">
                                </div>
                                @error('position')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
